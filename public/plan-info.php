      ...
      <?php foreach ($resp['journeys'] as $index => $journey): ?>
        <li class="plan--list">
          <div class="journey--section">
            ...
            <form action="step-info.php?legs=<?php echo urlencode(json_encode($journeyLegs[$index])); ?>" method="POST">
              <button class="step-info-button">Click here to reveal the steps</button>
            </form>
          </div>
        </li>
      <?php endforeach; ?>
